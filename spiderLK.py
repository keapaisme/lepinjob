...
def main():
    for i in range(1, 51):
        ...
        url = "https://msearch.51job.com/job_list.php?keyword="+kw+"&keywordtype=2&jobarea=000000&fromapp=&pageno="+str(i)+""
...
def get_data(url):
    ...
    for i in result_link:
        ...
        job_list.append({"link": i['href'], "location": i.em.string, "company": i.aside.string, "job": i.span.string, "salary": i.i.string})
